...
namespace VendingIot.Controllers
{
    ...
    public class PermissionCategoryController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetPermissionCategories([FromQuery] int page = 1, [FromQuery] int pageSize = 10, [FromQuery] string? search = null)
        {
            try
            {
                page = page < 1 ? 1 : page;
                ...
                var query = _context.PermissionCategories.AsQueryable();
                ...
                var permissionCategories = await query
